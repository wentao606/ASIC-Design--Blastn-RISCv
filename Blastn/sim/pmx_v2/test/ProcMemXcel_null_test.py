...
from pmx_v2.test.ProcMemXcelFL_null_test import Tests as ProcMemXcelFL_null_TestsBaseClass

#-------------------------------------------------------------------------
# Tests
#-------------------------------------------------------------------------

class Tests( ProcMemXcelFL_null_TestsBaseClass ):
