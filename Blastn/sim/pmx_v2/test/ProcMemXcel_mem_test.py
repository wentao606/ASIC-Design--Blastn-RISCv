...
from pmx_v2.test.ProcMemXcelFL_mem_test import Tests as ProcMemXcelFL_mem_TestsBaseClass

#-------------------------------------------------------------------------
# Tests
#-------------------------------------------------------------------------

class Tests( ProcMemXcelFL_mem_TestsBaseClass ):
