...
from pymtl3.stdlib.primitive import Mux, RegEn, RegRst
from pymtl3.stdlib.primitive import LTComparator, ZeroComparator, Subtractor
...
class GcdUnitRTL( Component ):
  ...
  def construct( s ):
    ...
    s.dpath.req_msg_a //= s.istream.msg.a
    s.dpath.req_msg_b //= s.istream.msg.b
    s.dpath.resp_msg  //= s.ostream.msg
    s.ctrl.req_val    //= s.istream.val
    s.ctrl.req_rdy    //= s.istream.rdy
    s.ctrl.resp_val   //= s.ostream.val
    s.ctrl.resp_rdy   //= s.ostream.rdy
  ...
  def line_trace( s ):
    ...
    return f"{s.istream}({s.dpath.a_reg.out} " \
           f"{s.dpath.b_reg.out} {state_str}){s.ostream}"
