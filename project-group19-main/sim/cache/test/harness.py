...
class TestHarness( Component ):
  ...
  def construct( s, dut, cmp_fn=compare_cacheresp ):
    ...
    s.src   = StreamSourceFL( MemReqMsg16B )
    s.cache = dut
    s.mem   = MemoryFL( 1, [(MemReqMsg16B,MemRespMsg16B)] )
    s.sink  = StreamSinkFL( MemRespMsg16B, cmp_fn=cmp_fn )
...
def run_test( CacheModel, test_params, cmdline_opts=None, cmp_fun=compare_cacheresp ):
